...
#            'ell_L',
    ...
    def setup(self):
        ...
        par.tol_ss = 1e-09 # tolerance when finding steady state
        par.tol_solve = 1e-09 # tolerance when solving
        par.tol_simulate = 1e-09 # tolerance when simulating
        par.tol_broyden = 1e-09 # tolerance when solving eq. system
